#
#  Be sure to run `pod spec lint DNAKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  A UI component library written in swift, inspired by Atomic Design by Brad Frost. A repository of reusable, customizable and stateful UI components and interactions for building modular and flexible UI elements in swift.
  ...
  spec.homepage     = "https://github.com/shivanid95/DNAKit"
  ...
  spec.author             = { "Shivani" => "shivani.dosajh12@gmail.com" }
  # Or just: spec.author    = "Shivani"
  # spec.authors            = { "Shivani" => "shivai.dosajh@smallcase.com" }
  # spec.social_media_url   = "https://twitter.com/Shivani"
